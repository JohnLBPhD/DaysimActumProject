...
namespace DaySim.Framework.ChoiceModels {
  public sealed class ChoiceModelHelper {
    ...
    public static void Initialize(ref ChoiceModelHelper helper, string choiceModelName, string coefficientsPath,
      ...
      bool modelIsInEstimationMode = Global.Configuration.IsInEstimationMode &&
    ...
    private static readonly string[] _modelName = new string[maxModelsRun];
    private static readonly int[] _timesModelRun = new int[maxModelsRun];
    ...
    public static void WriteTimesModelsRun() {
      for (int nModel = 0; nModel < _nModelsRun; nModel++) {
