              ...
              for (int transitAccess = Global.Settings.TransitAccesses.Gt0AndLteQtrMi; transitAccess < Global.Settings.TransitAccesses.TotalTransitAccesses; transitAccess++) {
                ...
                foreach (ISubzone subzone in subzones) {
                  ...
                  if (setImpedance) {
                    ...
                    dynamic walkPath = pathTypeModels.First();
                    ...
                    dynamic sovDistanceFromOrigin = (sovPath.PathDistance / Global.Settings.DistanceUnitsPerMile) / 2D;
                    ...
                    dynamic hov2Path = pathTypeModels.First();
                    ...
                    dynamic transitPath = pathTypeModels.First();
