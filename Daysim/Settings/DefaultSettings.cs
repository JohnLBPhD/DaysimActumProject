...
namespace DaySim.Settings {
  ...
  public class DefaultSettings : ISettings {
    ...
    public virtual bool UseJointTours => true;
  ...
  public class DefaultPathTypes : IPathTypes {
    public virtual int TotalPathTypes => 8;
    ...
    public virtual int NewMode => 4;

    public virtual int Brt => 5;

    public virtual int FixedGuideway => 6;

    public virtual int BrtC2 => 7;

    public virtual int FixedGuidewayC2 => 8;

    public virtual int LocalBusPnr => 9;

    public virtual int NewModePnr => 10;

    public virtual int BrtPnr => 11;

    public virtual int FixedGuidewayPnr => 12;

    public virtual int BrtC2Pnr => 13;

    public virtual int FixedGuidewayC2Pnr => 14;

    public virtual int LocalBusKnr => 15;

    public virtual int NewModeKnr => 16;

    public virtual int BrtKnr => 17;

    public virtual int FixedGuidewayKnr => 18;

    public virtual int BrtC2Knr => 19;

    public virtual int FixedGuidewayC2Knr => 20;
  }
  ...
  public class DefaultTimes : ITimes {
    ...
    public virtual int MinimumActivityDuration => 2;
