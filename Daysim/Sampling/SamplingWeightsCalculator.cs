...
namespace DaySim.Sampling {
  public sealed class SamplingWeightsCalculator {
    ...
    private SegmentZone[] ComputeSegment(int segment) {
      double[] sizeFactors = Global.Kernel.Get<SamplingWeightsSettingsFactory>().SamplingWeightsSettings.SizeFactors[segment];
      double[] weightFactors = Global.Kernel.Get<SamplingWeightsSettingsFactory>().SamplingWeightsSettings.WeightFactors[segment];
