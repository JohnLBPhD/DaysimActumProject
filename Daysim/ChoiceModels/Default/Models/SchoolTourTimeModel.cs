...
namespace DaySim.ChoiceModels.Default.Models {
  public class SchoolTourTimeModel : ChoiceModel {
    ...
    public override void RunInitialize(ICoefficientsReader reader = null) {
      Initialize(CHOICE_MODEL_NAME, Global.Configuration.SchoolTourTimeModelCoefficients, TourTime.TOTAL_TOUR_TIMES, TOTAL_NESTED_ALTERNATIVES, TOTAL_LEVELS, MAX_PARAMETER);
    }
