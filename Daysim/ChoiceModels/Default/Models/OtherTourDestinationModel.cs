  ...
  public class OtherTourDestinationModel : ChoiceModel {
    ...
    private sealed class TourDestinationUtilities : ISamplingUtilities {
      ...
      public void SetUtilities(ISampleItem sampleItem, int sampleFrequency) {
        ...
        double distanceFromOrigin3 = Math.Max(0, distanceFromOrigin - 1);
        double distanceFromOrigin4 = Math.Min(distanceFromOrigin, .10);
        double distanceFromOrigin5 = Math.Max(0, Math.Min(distanceFromOrigin - .1, .5 - .1));
