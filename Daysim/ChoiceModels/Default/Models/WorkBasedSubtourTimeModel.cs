...
namespace DaySim.ChoiceModels.Default.Models {
  public class WorkBasedSubtourTimeModel : ChoiceModel {
    private const string CHOICE_MODEL_NAME = "WorkBasedSubtourTimeModel";
    private const int TOTAL_NESTED_ALTERNATIVES = 0;
    private const int TOTAL_LEVELS = 1;
    private const int MAX_PARAMETER = 180;

    public override void RunInitialize(ICoefficientsReader reader = null) {
      Initialize(CHOICE_MODEL_NAME, Global.Configuration.WorkBasedSubtourTimeModelCoefficients, TourTime.TOTAL_TOUR_TIMES, TOTAL_NESTED_ALTERNATIVES, TOTAL_LEVELS, MAX_PARAMETER);
    }
    ...
    public void Run(ITourWrapper subtour) {
      ...
      ChoiceProbabilityCalculator choiceProbabilityCalculator = _helpers[ParallelUtility.GetBatchFromThreadId()].GetChoiceProbabilityCalculator(subtour.Id);
