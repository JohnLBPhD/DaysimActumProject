...
namespace DaySim.ChoiceModels.Default.Models {
  public class PersonExactNumberOfToursModel : ChoiceModel {
    ...
    public void Run(IPersonDayWrapper personDay, int purpose) {
      ...
      ChoiceProbabilityCalculator choiceProbabilityCalculator = _helpers[ParallelUtility.GetBatchFromThreadId()].GetChoiceProbabilityCalculator((personDay.Id * 397) ^ purpose);
