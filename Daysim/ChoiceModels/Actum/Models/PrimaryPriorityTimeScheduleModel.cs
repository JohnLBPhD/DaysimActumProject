...
namespace DaySim.ChoiceModels.Actum.Models {
  public class PrimaryPriorityTimeScheduleModel : ChoiceModel {
    ...
    public void Run(HouseholdDayWrapper householdDay) {
      ...
      ChoiceProbabilityCalculator choiceProbabilityCalculator = _helpers[ParallelUtility.GetBatchFromThreadId()].GetChoiceProbabilityCalculator(householdDay.Household.Id);
