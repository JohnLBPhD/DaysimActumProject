...
namespace DaySim.ChoiceModels.H.Models {
  public class IntermediateStopLocationModel : ChoiceModel {
    ...
    public void Run(ITripWrapper trip, IHouseholdDayWrapper householdDay, int sampleSize) {
      if (trip == null) {
      ...
      ChoiceProbabilityCalculator choiceProbabilityCalculator = _helpers[ParallelUtility.GetBatchFromThreadId()].GetChoiceProbabilityCalculator(trip.Id);
    ...
    private void RunModel(ChoiceProbabilityCalculator choiceProbabilityCalculator, ITripWrapper trip, IHouseholdDayWrapper householdDay, int sampleSize, IParcelWrapper choice = null) {
      ...
      int segment = Global.Kernel.Get<SamplingWeightsSettingsFactory>().SamplingWeightsSettings.GetIntermediateStopSegment(trip.DestinationPurpose, trip.Tour.Mode);
    ...
    private sealed class IntermediateStopLocationUtilities : ISamplingUtilities {
      ...
      public void SetUtilities(ISampleItem sampleItem, int sampleFrequency) {
        ...
        int personalBusiness_Meal_Shop_Social_Or_RecreationStopPurposeFlag = (personalReasonsDestinationPurposeFlag == 1 || recreationStopPurposeFlag == 1).ToFlag();
        ...
        double dist = Math.Max(adis1 + adis2 - adis0, Math.Min(adis1 * 0.1, adis2 * 0.1)); // incremental distance (with imposed lower limit), in distance units
        ...
        logOfOneMinusRatioOfTravelTimeToAvailableTimeWindow = Math.Log(1 - Math.Pow(logOfOneMinusRatioOfTravelTimeToAvailableTimeWindow, 0.1));
        //logOfOneMinusRatioOfTravelTimeToAvailableTimeWindow = -1.0 * (Math.Pow((-1.0 * Math.Log(1 - Math.Pow(logOfOneMinusRatioOfTravelTimeToAvailableTimeWindow, 0.2))),1.2));
        ...
        alternative.AddUtilityTerm(3, gtime_DistanceSensitiveDetourGeneralizedTimeHundredsOfMinutes);
        alternative.AddUtilityTerm(4, gtimeSquared);
        alternative.AddUtilityTerm(5, gtimeCubed);
        ...
        alternative.AddUtilityTerm(9, household.HasIncomeUnder50K.ToFlag() * gtime_DistanceSensitiveDetourGeneralizedTimeHundredsOfMinutes);
        alternative.AddUtilityTerm(10, household.Has100KPlusIncome.ToFlag() * gtime_DistanceSensitiveDetourGeneralizedTimeHundredsOfMinutes);
        alternative.AddUtilityTerm(11, household.HasMissingIncome.ToFlag() * gtime_DistanceSensitiveDetourGeneralizedTimeHundredsOfMinutes);
        ...
        alternative.AddUtilityTerm(15, (!tour.IsHomeBasedTour).ToFlag() * proximityToTourOrigin_10Is1min_1Is10min_point1Is100min);
        ...
        alternative.AddUtilityTerm(78, stopOnJointTour * gtime_DistanceSensitiveDetourGeneralizedTimeHundredsOfMinutes);
        alternative.AddUtilityTerm(79, stopOnFullJointHalfTour * gtime_DistanceSensitiveDetourGeneralizedTimeHundredsOfMinutes);
        ...
        alternative.AddUtilityTerm(23, (!tour.IsAnAutoMode()).ToFlag() * gtime_DistanceSensitiveDetourGeneralizedTimeHundredsOfMinutes);
        //				alternative.AddUtility(, tour.IsBikeMode.ToFlag() * gtim);
        //				alternative.AddUtility(, tour.IsWalkMode.ToFlag() * gtim);
        alternative.AddUtilityTerm(24, (!tour.IsAnAutoMode()).ToFlag() * gtimeSquared);
        alternative.AddUtilityTerm(25, (!tour.IsAnAutoMode()).ToFlag() * gtimeCubed);
        ...
        alternative.AddUtilityTerm(33, personalBusiness_Meal_Shop_Social_Or_RecreationStopPurposeFlag * person.IsYouth.ToFlag() * logOfOnePlusStudentsK12Buffer1);
        alternative.AddUtilityTerm(77, personalBusiness_Meal_Shop_Social_Or_RecreationStopPurposeFlag * person.IsUniversityStudent.ToFlag() * logOfOnePlusStudentsUniversityBuffer1);

        if (_trip.DestinationPurpose == Global.Settings.Purposes.Work) {
          // Neighborhood
          alternative.AddUtilityTerm(34, workDestinationPurposeFlag * logOfOnePlusEmploymentTotalBuffer1);
          alternative.AddUtilityTerm(35, workDestinationPurposeFlag * logOfOnePlusStudentsK12Buffer1);

          // Size terms
          alternative.AddUtilityTerm(101, workDestinationPurposeFlag * employmentGovernment_Office_Education);
          alternative.AddUtilityTerm(158, workDestinationPurposeFlag * destinationParcel.EmploymentService);
          alternative.AddUtilityTerm(102, workDestinationPurposeFlag * destinationParcel.EmploymentTotal);
          ...
          alternative.AddUtilityTerm(104, schoolStopForChildUnderAge16 * studentsK12);
          alternative.AddUtilityTerm(105, schoolStopForDrivingAgeStudent * employmentGovernment_Office_Education); //
          alternative.AddUtilityTerm(106, schoolStopForDrivingAgeStudent * studentsK12);
          ...
          // Neighborhood
          alternative.AddUtilityTerm(040, escortStop_HouseholdHasChildren * logOfOnePlusEmploymentIndustrial_Ag_ConstructionBuffer1);
          //						alternative.AddUtility(, eskdFlag * emprq);
          //						alternative.AddUtility(, eskdFlag * emptq);
          alternative.AddUtilityTerm(041, escortStop_HouseholdHasChildren * logOfOnePlusStudentsK12Buffer1);
          ...
          // Size terms
          alternative.AddUtilityTerm(109, escortStop_HouseholdHasChildren * studentsK12);
          ...
          alternative.AddUtilityTerm(113, escortStop_HouseholdHasNoChildren * studentsK12);
          ...
          // Neighborhood
          alternative.AddUtilityTerm(44, personalBusinessStopPurposeFlag * logOfOnePlusEmploymentMedicalBuffer1);
          alternative.AddUtilityTerm(73, personalBusinessStopPurposeFlag * logOfOnePlusStudentsK12Buffer1);
          alternative.AddUtilityTerm(45, personalBusinessStopPurposeFlag * logOfOnePlusEmploymentFoodBuffer1);
          alternative.AddUtilityTerm(46, personalBusinessStopPurposeFlag * logOfOnePlusEmploymentRetailBuffer1);

          // Size terms
          alternative.AddUtilityTerm(115, personalBusinessStopPurposeFlag * destinationParcel.EmploymentFood); //
          alternative.AddUtilityTerm(116, personalBusinessStopPurposeFlag * employmentIndustrial_Ag_Construction);
          alternative.AddUtilityTerm(117, personalBusinessStopPurposeFlag * destinationParcel.EmploymentMedical);
          ...
          alternative.AddUtilityTerm(50, mealStopPurposeFlag * gtime_DistanceSensitiveDetourGeneralizedTimeHundredsOfMinutes);

          // Neighborhood
          alternative.AddUtilityTerm(51, mealStopPurposeFlag * logOfOnePlusEmploymentFoodBuffer1);
          alternative.AddUtilityTerm(71, mealStopPurposeFlag * logOfOnePlusEmploymentGovernment_Office_EducationBuffer1);
          alternative.AddUtilityTerm(72, mealStopPurposeFlag * logOfOnePlusEmploymentRetailBuffer1);

          // Size terms
          alternative.AddUtilityTerm(126, mealStopPurposeFlag * destinationParcel.EmploymentFood);
          //alternative.AddUtilityTerm(127, mealStopPurposeFlag * destinationParcel.EmploymentTotal);//
          //alternative.AddUtilityTerm(128, mealStopPurposeFlag * destinationParcel.Households);//
          //alternative.AddUtilityTerm(149, mealStopPurposeFlag * destinationParcel.EmploymentRetail);//
          //alternative.AddUtilityTerm(150, mealStopPurposeFlag * destinationParcel.EmploymentService);//
          ...
          // Neighborhood
          alternative.AddUtilityTerm(53, socialStopPurposeFlag * logOfOnePlusEmploymentFoodBuffer1);
          alternative.AddUtilityTerm(54, socialStopPurposeFlag * logOfOnePlusEmploymentIndustrial_Ag_ConstructionBuffer1);
          ...
          alternative.AddUtilityTerm(75, socialStopPurposeFlag * logOfOnePlusStudentsK12Buffer1);
          alternative.AddUtilityTerm(57, socialStopPurposeFlag * logOfOnePlusHouseholdsBuffer1);

          // Size terms
          alternative.AddUtilityTerm(129, socialStopPurposeFlag * destinationParcel.EmploymentFood);
          //alternative.AddUtilityTerm(130, socialStopPurposeFlag * destinationParcel.EmploymentMedical);//
          ...
          alternative.AddUtilityTerm(153, socialStopPurposeFlag * destinationParcel.GetStudentsK12());
          alternative.AddUtilityTerm(154, socialStopPurposeFlag * destinationParcel.StudentsUniversity);
        } else if (_trip.DestinationPurpose == Global.Settings.Purposes.Recreation) {
          alternative.AddUtilityTerm(58, recreationStopPurposeFlag * gtime_DistanceSensitiveDetourGeneralizedTimeHundredsOfMinutes);

          // Neighborhood
          alternative.AddUtilityTerm(59, recreationStopPurposeFlag * logOfOnePlusEmploymentFoodBuffer1);
          alternative.AddUtilityTerm(60, recreationStopPurposeFlag * logOfOnePlusEmploymentIndustrial_Ag_ConstructionBuffer1);
          alternative.AddUtilityTerm(61, recreationStopPurposeFlag * logOfOnePlusEmploymentServiceBuffer1);
          alternative.AddUtilityTerm(62, recreationStopPurposeFlag * logOfOnePlusEmploymentTotalBuffer1);
          alternative.AddUtilityTerm(76, recreationStopPurposeFlag * logOfOnePlusStudentsK12Buffer1);
          alternative.AddUtilityTerm(63, recreationStopPurposeFlag * logOfOnePlusHouseholdsBuffer1);

          // Size terms
          //alternative.AddUtilityTerm(135, recreationStopPurposeFlag * destinationParcel.EmploymentFood);
          alternative.AddUtilityTerm(136, recreationStopPurposeFlag * destinationParcel.EmploymentGovernment);
          //alternative.AddUtilityTerm(155, recreationStopPurposeFlag * destinationParcel.EmploymentRetail);
          //alternative.AddUtilityTerm(137, recreationStopPurposeFlag * destinationParcel.EmploymentService);
          //alternative.AddUtilityTerm(138, recreationStopPurposeFlag * destinationParcel.EmploymentTotal);
          //alternative.AddUtilityTerm(139, recreationStopPurposeFlag * openSpaceType2IsPresentInBuffer1);
          //alternative.AddUtilityTerm(140, recreationStopPurposeFlag * destinationParcel.Households);
          //alternative.AddUtilityTerm(156, recreationStopPurposeFlag * destinationParcel.StudentsK12);
          alternative.AddUtilityTerm(157, recreationStopPurposeFlag * destinationParcel.StudentsUniversity);
        } else if (_trip.DestinationPurpose == Global.Settings.Purposes.Medical) {
          // Neighborhood
          alternative.AddUtilityTerm(64, medicalStopPurposeFlag * logOfOnePlusEmploymentMedicalBuffer1);
          alternative.AddUtilityTerm(74, medicalStopPurposeFlag * logOfOnePlusStudentsK12Buffer1);
          alternative.AddUtilityTerm(65, medicalStopPurposeFlag * logOfOnePlusEmploymentFoodBuffer1);
          alternative.AddUtilityTerm(66, medicalStopPurposeFlag * logOfOnePlusEmploymentRetailBuffer1);

          // Size terms
          //alternative.AddUtilityTerm(141, medicalStopPurposeFlag * destinationParcel.EmploymentFood);
          //alternative.AddUtilityTerm(142, medicalStopPurposeFlag * employmentIndustrial_Ag_Construction);
          alternative.AddUtilityTerm(143, medicalStopPurposeFlag * destinationParcel.EmploymentMedical);
          //alternative.AddUtilityTerm(144, medicalStopPurposeFlag * employmentGovernment_Office_Education);
          //alternative.AddUtilityTerm(145, medicalStopPurposeFlag * destinationParcel.EmploymentRetail);
          //alternative.AddUtilityTerm(146, medicalStopPurposeFlag * destinationParcel.EmploymentService);
          //alternative.AddUtilityTerm(147, medicalStopPurposeFlag * destinationParcel.Households);
        }
      }
